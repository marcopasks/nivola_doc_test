...
La gestione, del ciclo di vita dei **Volumi**, si traduce in queste operazioni: 
...
Il comando con cui, poter ottenere il dettaglio circa la costituzione di un *Volume*, è:
...
Per scollegare e cancellare un *Volume*, servono queste istruzioni:
