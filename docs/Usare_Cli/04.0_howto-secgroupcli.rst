...
La gestione del ciclo di vita dei **Security Group**, si svolge attraverso questi scenari:
...
La lista dei SG, è fornita dal sistema, sfruttando il comando:
...
La creazione di un Security Group, avviene con l'istruzione:
...
Per aggiungere regole di ingresso e di uscita ad un Security Group, il comando da sfruttare è il seguente:
...
La lista dei *template* a disposizione, nell'uso dei Security Group, è ottenuta tramite l'istruzione:
...
Il comando con cui, ottenere il dettaglio circa la costituzione di un *Security Group*, è il seguente:
...
La cancellazione di una regola da un *SG*, prevede l'uso del comando:
