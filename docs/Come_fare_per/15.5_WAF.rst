...
Occorre andare nella funzionalità **Certificati su WAF**, attivabile dalla parte sinistra dello schermo, all'interno del menù **WAF**, a sua volta 
...
La funzione è attivabile attraverso il ruolo **Master di account**.
Occorre andare nella funzionalità **Verifiche su WAF**, attivabile dalla parte sinistra dello schermo, all'interno del menù **WAF**, a sua volta 
contenuto all'interno del menù **Reti e Sicurezza**
...
La funzione è attivabile attraverso il ruolo **Master di account**.
Occorre andare nella funzionalità **Dismissione server su WAF**, attivabile dalla parte sinistra dello schermo, all'interno del menù **WAF**, a sua volta 
contenuto all'interno del menù **Reti e Sicurezza**
